...
public class CloudRepository {
    ...
    public Observable<ArrayList<GameIGDB>> getGameByName(String name) {
        ...
        return restService.getService().getGamesByName(name,"name,popularity",50 ,"1",marti.com.example.exampleapp.Application.getInstance().getApplicationContext().getString(R.string.igdb_api_key), "application/json");
